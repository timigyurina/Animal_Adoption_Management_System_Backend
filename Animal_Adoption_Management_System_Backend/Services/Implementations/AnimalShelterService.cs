...
{
    public class AnimalShelterService : GenericService<AnimalShelter>, IAnimalShelterService
    {
        public AnimalShelterService(AnimalAdoptionContext context, IMapper mapper) : base(context, mapper)
        {
        }
